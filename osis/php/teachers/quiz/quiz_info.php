...
$sub = $_POST["sub"];
  ...
  $sql = $con->query("SELECT DISTINCT t.term_name, c.cname, y.ac_yr, qa.sid, s.sub_name, concat(st.firstname, " ", st.last_name) as fullname,
                      FROM quiz_ans qa
                      ...
                      JOIN students st ON st.sid = q.sid
