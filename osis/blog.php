<?php include 'home_page/header.html'; ?>    <!-- END nav -->
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('home_page/images/bg_2.jpg');">
      ...
      <div class="container">
		...
		<section class="ftco-section bg-light">
			<div class="container">
        <?php
          include 'php/admin/events/blogs.php';
        ?>
			</div>
		</section>
  ...
  <script type="text/javascript">
    var content = document.querySelector(".blg-msg").innerHTML;
    document.querySelector(".blg-msg").innerHTML = content.slice(0,150)+"....";
  </script>
