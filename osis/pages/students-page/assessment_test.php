    ...
    <div class="widget-box">
      ...
      <div class="widget-content nopadding">
        <div class="filter_menu">
          ...
          <span><button id="search_test" class="btn btn-info btn-sm">Search</button></span>
        </div>
      </div>
    </div>
    <div class="row-fluid" id="filtered_data">
...
<script src="../../plugins/myjs/student/assessments/filter_assessments.js"></script>
<script src="../../plugins/myjs/student/assessments/students_ac.js"></script>
</body>
</html>
