              ...
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <div class="filter_menu">
                    <select class="subject span2" name="subject">
                    </select>
                    <select class="level span2" name="level">
                    </select>
                    <select class="year span2" name="year">
                    </select>
                    <select class="term span2" name="term">
                    </select>
                    <span><button id="search_quiz" class="btn btn-info btn-sm">Search</button></span>
                  </div>
                </div>
              </div>
            </div>
...
<script type="text/javascript">
    ...
    var class_id = '<?php echo $_SESSION["student_class"];?>';
    var stream = '<?php echo $_SESSION["stream"];?>';
    var sid = '<?php echo $_SESSION["sid"];?>';
    var quick_actions = document.querySelector('.quick-actions_homepage');
...
<script src="../../plugins/myjs/student/quiz/filter_quiz.js"></script>
</body>
</html>
