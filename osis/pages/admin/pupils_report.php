...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>Home</a><ul>
    ...
    <li class="active"><a href="pupils_report.php"><i class="icon icon-list"></i> <span>Report Slip</span></a></li>
        ...
        <div class="widget-box">
          <!-- <div class="widget-title">
            <ul class="nav nav-tabs">
              <li class="active">
                <a href="#b1" data-toggle="tab">Basic 1</a>
              </li>
              <li>
                <a href="#b2" data-toggle="tab">Basic 2</a>
              </li>
              <li>
                <a href="#b3" data-toggle="tab">Basic 3</a>
              </li>
              <li>
                <a href="#b4" data-toggle="tab">Basic 4</a>
              </li>
              <li>
                <a href="#b5" data-toggle="tab">Basic 5</a>
              </li>
              <li>
                <a href="#b6" data-toggle="tab">Basic 6</a>
              </li>
              <li>
                <a href="#b7" data-toggle="tab">Basic 7</a>
              </li>
              <li>
                <a href="#b8" data-toggle="tab">Basic 8</a>
              </li>
              <li>
                <a href="#b9" data-toggle="tab">Basic 9</a>
              </li>
            </ul>
          </div> -->
...
<script src="../../plugins/myjs/admin/results/pupils_report.js"></script>
