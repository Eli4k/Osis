...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <ul class="quick-actions">
          <li title="Enter Names and Details of students"> <a href="admin_students.php"><img src="../../img/sir.png" style="width:200px">
            <hr>
            <p>STUDENTS</p></a> </li>
          <li title="Add informations for Teachers"> <a href="admin_teachers.php"><img src="../../img/35.png" style="width:200px">
            <hr>
              <p>TEACHERS</p>
            </a>
           </li>
          <li title="Check verified Exam results from teachers and Send Email Notifications to Parents "> <a href="pupils_report.php"><img src="../../img/exam.png" style="width:200px">
            <hr>
            <p>Result Slip</p></a> </li>
           <li title="Add, Edit or Remove Subjects, Classes Etc"> <a href="admin_acc.php"><img src="../../img/test.png" style="width:200px">
            <hr>
            <p>ACADEMICS</p></a> </li>
            <li title="Edit or Add contents unto website page"> <a href="website.php"><img src="../../img/web.png" style="width:200px">
             <hr>
             <p>WEBSITE</p></a> </li>
        </ul>
   </div>
