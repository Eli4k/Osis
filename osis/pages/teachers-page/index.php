...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <ul class="quick-actions">
          ...
          <!-- Assessment test -->
            <li title="Enter Students Assessment tests and submit to parents via email">
              <a href="my-class.php">
                <img src="../../img/test.png" width="220px">
                <hr>
                CLASS ASSESSMENTS
              </a>
          </li>
          ...
          <!-- Quizz -->
              <li title="Setup Quizz for students">
                <a href="quiz.php">
                    <img src="../../img/quiz.png" width="220px">
                    <hr>
                    Quizz
                </a>
              </li>
        <!-- End -->
            ...
            <!-- Test Results and Exam result Page -->
            <li>
                <a href="final_assessment.php">
                  <img src="../../img/checklist.png" width="220px">
                   <hr>
                  Results
                </a>
           </li>
