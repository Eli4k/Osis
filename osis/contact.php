<?php include 'home_page/header.html'; ?>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('home_page/images/bg_2.jpg');">
        ...
        <div class="row d-flex mb-5 contact-info">
          <div class="col-md-3 d-flex">
          	<div class="bg-light align-self-stretch box p-4 text-center">
	            ...
	            <p class="location">198 West 21th Street, Suite 721 New York NY 10016</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="bg-light align-self-stretch box p-4 text-center">
          		<h3 class="mb-4">Contact Number</h3>
	            <p><a href="tel://1234567920"><span class="phone">+ 1235 2355 98</span></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="bg-light align-self-stretch box p-4 text-center">
          		<h3 class="mb-4">Email Address</h3>
	            <p><a href="mailto:info@yoursite.com"><span class="email">info@yoursite.com</span></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="bg-light align-self-stretch box p-4 text-center">
          		<h3 class="mb-4">Website</h3>
	            <p class="web">yoursite.com</p>
	          </div>
          </div>
        </div>
      </div>
